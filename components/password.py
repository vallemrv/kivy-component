...
class Password(AnchorLayout):
    ...
    botones = ListProperty([
        {'text': '1', "bg_color":'#999999', 'num': '1'},
        {'text': '2', "bg_color":'#999999', 'num': '2'},
        {'text': '3', "bg_color":'#999999', 'num': '3'},
        {'text': '4', "bg_color":'#999999', 'num': '4'},
        {'text': '5', "bg_color":'#999999', 'num': '5'},
        {'text': '6', "bg_color":'#999999', 'num': '6'},
        {'text': '7', "bg_color":'#999999', 'num': '7'},
        {'text': '8', "bg_color":'#999999', 'num': '8'},
        {'text': '9', "bg_color":'#999999', 'num': '9'},
        {'text': '0', "bg_color":'#999999', 'num': '0'},
    ])
    ...
    def random_botones(self):
        ...
        botonesOut.append({'text': 'C', "bg_color":'#f09696', 'num': 'C'})
        botonesOut.append({'text': 'OK', "bg_color":'#c6e494', 'num': 'OK'})
